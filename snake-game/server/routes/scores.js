...
/**
 * Creates the scores router with the given Prisma client.
 * Accepts prisma as a parameter to enable dependency injection for testing.
 */
function createScoresRouter(prisma) {
